...
# A function loop over yolov3.cfg file and store each line in a list
...
# Use the above function to extract the network architecture and construct the network.
...
def YOLOv3Net(cfgfile, model_size, num_classes):
    ...
    for i, block in enumerate(blocks[1:]):
        ...
        # Yolo detection layer
            ...
            # Add the gird location with the predicted center, which are values between (0,1), and multiple by stride to generate a value proper for the object.
